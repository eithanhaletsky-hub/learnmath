...
<div class="formula-box">$\\text{אם } f(x) = 2x + 1 \\text{ אז } f(3) = 2(3)+1 = 7$</div>`,
    ...
    },
    {
        ...
        theory: `
<h3>מהי פונקציה לינארית?</h3>
<p>פונקציה לינארית היא הפונקציה הפשוטה ביותר — הגרף שלה הוא <strong>קו ישר</strong>. היא מתארת קשר שבו כל שינוי קבוע ב-$x$ גורם לשינוי קבוע ב-$y$. למשל: אם כל שעת עבודה מרוויחה 50 ש"ח, הקשר בין שעות לרווח הוא לינארי.</p>

<h3>הנוסחה</h3>
<div class="formula-box">$f(x) = mx + b$</div>
<p>$m$ — שיפוע הישר (קצב השינוי)</p>
...
<p>רביע I ($0°$-$90°$): sin חיובי, cos חיובי</p>
<p>רביע II ($90°$-$180°$): sin חיובי, cos שלילי</p>
<p>רביע III ($180°$-$270°$): sin שלילי, cos שלילי</p>
<p>רביע IV ($270°$-$360°$): sin שלילי, cos חיובי</p>
        ...
        questions: [
            {
                ...
                correct: 1,
                explanation: 'מפגש התיכונים = מרכז כובד.'
            },
            {
            ...
            },
            {
                ...
                correct: 1,
                explanation: 'חוצי הזוויות = מרכז המעגל החסום.'
            },
            {
